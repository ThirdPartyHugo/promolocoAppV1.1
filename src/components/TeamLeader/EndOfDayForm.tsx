...
import { Calendar, Upload, DollarSign, FileCheck } from 'lucide-react';
      ...
      <form className="space-y-6">
        ...
        <div>
          ...
          <div className="space-y-4">
            <div className="flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 border-dashed rounded-lg relative">
